# Age Calculator
## [Video Demo](https://youtu.be/HtNe9prShyM)
### Description:
...
```
git clone https://github.com/Abdulkerim787/CS50P-Final-Project.git
```
#### Installation
...
![Input Image](https://github.com/Abdulkerim787/CS50P-Final-Project/blob/main/Images/Sample%20Input.png)

The Program output will be like this:

![Output Image](https://github.com/Abdulkerim787/CS50P-Final-Project/blob/main/Images/Sample%20Output.png)
